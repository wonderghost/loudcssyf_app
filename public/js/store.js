...
var store = new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  mutations: {
    setReactivationCount: function setReactivationCount(state, data) {
      state.reactivationCount = data;
    },
    setInfosComissions: function setInfosComissions(state, data) {
      state.infosComissionPercent = data;
    },
    setAlertInactifCount: function setAlertInactifCount(state, number) {
      state.alertInactifCount = number;
    },
    setAlertCount: function setAlertCount(state, number) {
      state.alertCount = number;
    },
    setFormuleList: function setFormuleList(state, list) {
    ...
    setMaterials: function setMaterials(state, list) {
...
module.exports = __webpack_require__(/*! /var/www/loudcssyf_app/resources/assets/js/store.js */"./resources/assets/js/store.js");
