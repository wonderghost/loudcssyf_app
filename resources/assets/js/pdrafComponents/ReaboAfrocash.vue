        ...
        <div class="uk-container uk-container-large">
            ...
            <div class="uk-grid-small uk-grid-divider" uk-grid>
                <div class="uk-width-2-3@m">
                    <div v-for="(err,index) in errors" :key="index" class="uk-alert-danger uk-width-1-2@m" uk-alert>
                        <a class="uk-alert-close" uk-close></a>
                        <p>{{err}}</p>
                    </div>
                    <div class="uk-width-1-2@m uk-alert-info uk-border-rounded uk-box-shadow-hover-small" uk-alert>
                    ...
                    <form @submit.prevent="sendReaboAfrocash()" class="uk-grid-small" uk-grid>
                        <div class="uk-width-1-3@m">
                            ...
                            <!-- <template v-if="dataForm.serial_number.length != 14">
                                <span class="uk-text-small uk-text-meta uk-text-warning">
                                    <span uk-icon="warning"></span> 14 Chiffres requis !
                                </span>
                            </template> -->
                        </div>
                        <div class="uk-width-1-3@m">
