        ...
        <li>
          ...
          <div id="modal-apport" uk-modal>
              <div class="uk-modal-dialog uk-modal-body">
                  ...
                  {!!Form::submit('validez',['class'=>'uk-button uk-button-small uk-button-primary uk-border-rounded uk-margin-small uk-box-shadow-small'])!!}
                  {!!Form::close()!!}
              </div>
          </div>
...
<!-- MODAL ADD DEPENSES -->
          <div id="modal-depenses" uk-modal>
              <div class="uk-modal-dialog uk-modal-body">
                  ...
                  {!!Form::submit('Envoyer',['class'=>'uk-button-primary uk-border-rounded uk-button uk-button-small uk-box-shadow-small'])!!}
                  {!!Form::close()!!}
              </div>
          </div>
